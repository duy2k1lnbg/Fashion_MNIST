...
def index():
    if request.method == 'POST':
        ...
        #labels of images
        class_names = ['áo thun/áo', 'quần dài', 'áo len', 'quần áo dạ hội / lễ phục', 'áo khoác ngoài','dép quai hậu', 'áo', 'giày thể thao', 'túi xách', 'giày boot']
...
if __name__ == "__main__":
    app.run(host="192.168.1.117",port=5000,debug=True,use_reloader=False)
